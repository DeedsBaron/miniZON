...
//go:generate minimock -i route256/checkout/internal/clients/loms.LomsService -o ./mocks/loms_service_minimock.go -n LomsServiceMock
...
// LomsServiceMock implements loms.LomsService
type LomsServiceMock struct {
	t minimock.Tester

	funcCreateOrder          func(ctx context.Context, userID models.UserID, items []models.Item) (op1 *models.OrderID, err error)
	inspectFuncCreateOrder   func(ctx context.Context, userID models.UserID, items []models.Item)
...
// NewLomsServiceMock returns a mock for loms.LomsService
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Expect(ctx context.Context, userID models.UserID, items []models.Item) *mLomsServiceMockCreateOrder {
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Inspect(f func(ctx context.Context, userID models.UserID, items []models.Item)) *mLomsServiceMockCreateOrder {
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Return(op1 *models.OrderID, err error) *LomsServiceMock {
	if mmCreateOrder.mock.funcCreateOrder != nil {
		mmCreateOrder.mock.t.Fatalf("LomsServiceMock.CreateOrder mock is already set by Set")
	}
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Set(f func(ctx context.Context, userID models.UserID, items []models.Item) (op1 *models.OrderID, err error)) *LomsServiceMock {
	if mmCreateOrder.defaultExpectation != nil {
...
// Then helper
func (mmCreateOrder *mLomsServiceMockCreateOrder) When(ctx context.Context, userID models.UserID, items []models.Item) *LomsServiceMockCreateOrderExpectation {
	if mmCreateOrder.mock.funcCreateOrder != nil {
		mmCreateOrder.mock.t.Fatalf("LomsServiceMock.CreateOrder mock is already set by Set")
	}
...
func (e *LomsServiceMockCreateOrderExpectation) Then(op1 *models.OrderID, err error) *LomsServiceMock {
	e.results = &LomsServiceMockCreateOrderResults{op1, err}
	return e.mock
}

// CreateOrder implements loms.LomsService
func (mmCreateOrder *LomsServiceMock) CreateOrder(ctx context.Context, userID models.UserID, items []models.Item) (op1 *models.OrderID, err error) {
...
func (mmStocks *mLomsServiceMockStocks) Return(sa1 []models.Stock, err error) *LomsServiceMock {
	if mmStocks.mock.funcStocks != nil {
		mmStocks.mock.t.Fatalf("LomsServiceMock.Stocks mock is already set by Set")
	}
	...
	mmStocks.defaultExpectation.results = &LomsServiceMockStocksResults{sa1, err}
	return mmStocks.mock
}

// Set uses given function f to mock the LomsService.Stocks method
func (mmStocks *mLomsServiceMockStocks) Set(f func(ctx context.Context, sku uint32) (sa1 []models.Stock, err error)) *LomsServiceMock {
	if mmStocks.defaultExpectation != nil {
...
func (e *LomsServiceMockStocksExpectation) Then(sa1 []models.Stock, err error) *LomsServiceMock {
	e.results = &LomsServiceMockStocksResults{sa1, err}
	return e.mock
}

// Stocks implements loms.LomsService
func (mmStocks *LomsServiceMock) Stocks(ctx context.Context, sku uint32) (sa1 []models.Stock, err error) {
