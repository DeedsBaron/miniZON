...
//go:generate minimock -i route256/checkout/internal/clients/ps.ProductService -o ./mocks/product_service_minimock.go -n ProductServiceMock
...
// ProductServiceMock implements ps.ProductService
type ProductServiceMock struct {
	t minimock.Tester

	funcGetProduct          func(ctx context.Context, sku uint32) (pp1 *models.ProductInfo, err error)
...
// NewProductServiceMock returns a mock for ps.ProductService
...
func (mmGetProduct *mProductServiceMockGetProduct) Return(pp1 *models.ProductInfo, err error) *ProductServiceMock {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductServiceMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mProductServiceMockGetProduct) Set(f func(ctx context.Context, sku uint32) (pp1 *models.ProductInfo, err error)) *ProductServiceMock {
	if mmGetProduct.defaultExpectation != nil {
...
func (e *ProductServiceMockGetProductExpectation) Then(pp1 *models.ProductInfo, err error) *ProductServiceMock {
	e.results = &ProductServiceMockGetProductResults{pp1, err}
	return e.mock
}

// GetProduct implements ps.ProductService
func (mmGetProduct *ProductServiceMock) GetProduct(ctx context.Context, sku uint32) (pp1 *models.ProductInfo, err error) {
