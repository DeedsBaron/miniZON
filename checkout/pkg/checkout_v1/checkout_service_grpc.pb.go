...
func (c *checkoutV1Client) CacheDelete(ctx context.Context, in *CacheDeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/checkout_v1.CheckoutV1/CacheDelete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCheckoutV1Server) CacheDelete(context.Context, *CacheDeleteRequest) (*emptypb.Empty, error) {
...
func _CheckoutV1_CacheDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CacheDeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CheckoutV1Server).CacheDelete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkout_v1.CheckoutV1/CacheDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutV1Server).CacheDelete(ctx, req.(*CacheDeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CheckoutV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CheckoutV1_CacheDelete_Handler,
		},
	},
