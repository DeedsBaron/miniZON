...
//go:generate minimock -i route256/libs/transactor.TransactionManager -o ./mocks/transaction_manager_minimock.go -n TransactionManagerMock
...
type TransactionManagerMock struct {
	...
	funcRunRepeteableReade          func(ctx context.Context, fx func(ctxTX context.Context) error) (err error)
	inspectFuncRunRepeteableReade   func(ctx context.Context, fx func(ctxTX context.Context) error)
...
func (mmRunRepeteableReade *mTransactionManagerMockRunRepeteableReade) Expect(ctx context.Context, fx func(ctxTX context.Context) error) *mTransactionManagerMockRunRepeteableReade {
	...
	mmRunRepeteableReade.defaultExpectation.params = &TransactionManagerMockRunRepeteableReadeParams{ctx, fx}
...
func (mmRunRepeteableReade *mTransactionManagerMockRunRepeteableReade) Inspect(f func(ctx context.Context, fx func(ctxTX context.Context) error)) *mTransactionManagerMockRunRepeteableReade {
...
func (mmRunRepeteableReade *mTransactionManagerMockRunRepeteableReade) Set(f func(ctx context.Context, fx func(ctxTX context.Context) error) (err error)) *TransactionManagerMock {
	if mmRunRepeteableReade.defaultExpectation != nil {
...
// Then helper
func (mmRunRepeteableReade *mTransactionManagerMockRunRepeteableReade) When(ctx context.Context, fx func(ctxTX context.Context) error) *TransactionManagerMockRunRepeteableReadeExpectation {
	if mmRunRepeteableReade.mock.funcRunRepeteableReade != nil {
		mmRunRepeteableReade.mock.t.Fatalf("TransactionManagerMock.RunRepeteableReade mock is already set by Set")
	}
	...
	expectation := &TransactionManagerMockRunRepeteableReadeExpectation{
		...
		params: &TransactionManagerMockRunRepeteableReadeParams{ctx, fx},
	}
...
// RunRepeteableReade implements transactor.TransactionManager
func (mmRunRepeteableReade *TransactionManagerMock) RunRepeteableReade(ctx context.Context, fx func(ctxTX context.Context) error) (err error) {
	...
	if mmRunRepeteableReade.inspectFuncRunRepeteableReade != nil {
		mmRunRepeteableReade.inspectFuncRunRepeteableReade(ctx, fx)
	}

	mm_params := &TransactionManagerMockRunRepeteableReadeParams{ctx, fx}
	...
	if mmRunRepeteableReade.RunRepeteableReadeMock.defaultExpectation != nil {
		...
		mm_got := TransactionManagerMockRunRepeteableReadeParams{ctx, fx}
	...
	if mmRunRepeteableReade.funcRunRepeteableReade != nil {
		return mmRunRepeteableReade.funcRunRepeteableReade(ctx, fx)
	}
	mmRunRepeteableReade.t.Fatalf("Unexpected call to TransactionManagerMock.RunRepeteableReade. %v %v", ctx, fx)
	return
}
